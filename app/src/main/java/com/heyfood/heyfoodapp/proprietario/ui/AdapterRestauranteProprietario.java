...
public class AdapterRestauranteProprietario extends RecyclerView.Adapter<AdapterRestauranteProprietario.MyViewHolder> {
    private List<Restaurante> listaRestaurante;

    public AdapterRestauranteProprietario(List<Restaurante> lista){
